...
-- DropForeignKey
ALTER TABLE "public"."RequestHistory" DROP CONSTRAINT "RequestHistory_userId_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."WorkspaceInvite" DROP CONSTRAINT "WorkspaceInvite_createdById_fkey";
